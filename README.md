...
- **Высокая производительность** с Next.js 16.1.1
- **Безопасность** - устранены все известные уязвимости (CVE-2025-66478)
...
- **React 19.1.4** - современная библиотека UI (обновлено для безопасности)
- **Next.js 16.1.1** - фреймворк с App Router (обновлено для устранения уязвимостей)
